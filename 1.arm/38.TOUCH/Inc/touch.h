...
#include "gt9xxx.h"
#include "ft5206.h"
#include "main.h"  //引脚定义 GT9XXX_INT、GT9XXX_RST、GT9XXX_MISO、GT9XXX_MOSI、GT9XXX_SCL
...
/* 电阻触摸屏控制引脚 */
#define T_PEN           HAL_GPIO_ReadPin(GT9XXX_INT_GPIO_Port, GT9XXX_INT_Pin)             /* T_PEN */
#define T_MISO          HAL_GPIO_ReadPin(GT9XXX_MISO_GPIO_Port, GT9XXX_MISO_Pin)           /* T_MISO */
